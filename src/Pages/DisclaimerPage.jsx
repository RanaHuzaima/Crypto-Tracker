      ...
      <section className=" max-w-screen-xl mx-auto mt-4 px-3 sm:px-0">
        <div className="bg-white p-4 mb-2 rounded-lg shadow-xl">
          <h1 className=" font-bold my-2 text-2xl">
            Disclaimers for Crypto Tracker
          </h1>

          <p>
            All the information on this website - Crypto Tracker.com - is
            published in good faith and for general information purpose only.
            Crypto Tracker does not make any warranties about the completeness,
            reliability and accuracy of this information. Any action you take
            upon the information you find on this website (Crypto Tracker), is
            strictly at your own risk. Crypto Tracker will not be liable for any
