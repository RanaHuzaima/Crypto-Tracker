...
const TermsConditionPage = () => {
  ...
  return (
    <>
      <section className=" max-w-screen-xl mx-auto mt-4 px-3 sm:px-0">
        <div className="bg-white p-4 mb-2 rounded-lg shadow-xl">
          <h2 className="mb-2 text-2xl">
            <strong>Terms and Conditions</strong>
          </h2>

          <p>Welcome to Crypto Tracker!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Crypto Tracker Service's Website, located at Crypto
            Tracker.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Crypto Tracker if you do not
          ...
          <p>
            ...
            subject to, prevailing law of pk. Any use of the above terminology
          ...
          <p>
            We employ the use of cookies. By accessing Crypto Tracker, you
            agreed to use cookies in agreement with the Crypto Tracker Service's
            Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Crypto Tracker Service and/or its licensors
            own the intellectual property rights for all material on Crypto
            Tracker. All intellectual property rights are reserved. You may
            access this from Crypto Tracker for your own personal use subjected
            to restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Crypto Tracker</li>
            <li>Sell, rent or sub-license material from Crypto Tracker</li>
            <li>Reproduce, duplicate or copy material from Crypto Tracker</li>
            <li>Redistribute content from Crypto Tracker</li>
          </ul>
          ...
          <p>
            ...
            Crypto Tracker Service does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Crypto Tracker Service,its agents
            ...
            applicable laws, Crypto Tracker Service shall not be liable for the
          ...
          <p>
            Crypto Tracker Service reserves the right to monitor all Comments
          ...
          <p>
            You hereby grant Crypto Tracker Service a non-exclusive license to
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Crypto
            Tracker Service; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Crypto Tracker Service. Please include your
          ...
          <p>
            No use of Crypto Tracker Service's logo or other artwork will be
