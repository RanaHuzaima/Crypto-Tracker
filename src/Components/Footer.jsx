...
const Footer = () => {
  ...
  return (
    <>
      <footer className="max-w-screen-xl mx-auto lg:px-0 px-3 mt-8">
        <div className=" px-6 pt-12 mx-auto  bg-gray-100 mb-2 rounded-lg shadow-slate-600 shadow-xl py-8">
