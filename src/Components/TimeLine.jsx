      ...
      <div className="container">
        <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2">
          ...
          <div className="flex flex-row-reverse md:contents">
            <div className="bg-black col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
          ...
          <div className="flex md:contents">
            ...
            <div className="bg-black col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
              <h3 className="font-bold text-2xl mb-1 text-white">Our Mission</h3>
              <p className="leading-tight text-justify text-white">
          ...
          <div className="flex flex-row-reverse md:contents">
            <div className="bg-black col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              <h3 className="font-bold text-2xl mb-1 text-white">Advanced Features</h3>
              <p className="leading-tight text-justify text-white">
          ...
          <div className="flex md:contents">
            ...
            <div className="bg-black col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
              <h3 className="font-bold text-2xl mb-1 text-white">User-Centric Platform</h3>
              <p className="leading-tight text-justify text-white">
